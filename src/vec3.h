...
public:
	...
	// Accessors for spatial and color vec3s
...
inline bool refract( const vec3& v, const vec3& n, float nint, vec3& refracted )
{
	...
	if( discriminant > 0 )
	{
		refracted = nint * (direction - n * dt) - n * sqrt( discriminant );
		return true;
	}
	else
	{
